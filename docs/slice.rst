...
.. function:: bool cork_slice_copy(struct cork_slice \*dest, struct cork_slice \*src, size_t offset, size_t length)
              bool cork_slice_copy_offset(struct cork_slice \*dest, struct cork_slice \*src, size_t offset)
...
.. function:: bool cork_slice_slice(struct cork_slice \*slice, size_t offset, size_t length)
              bool cork_slice_slice_offset(struct cork_slice \*slice, size_t offset)
...
.. function:: bool cork_slice_equal(const struct cork_slice \*slice1, const struct cork_slice \*slice2)
...
.. type:: struct cork_slice_iface
   ...
   .. member:: bool (\*copy)(struct cork_slice \*self, struct cork_slice \*dest, size_t offset, size_t length)

      Create a copy of a slice.  You can assume that *offset* and
      *length* refer to a valid subset of *self*\ 's content.

   .. member:: bool (\*slice)(struct cork_slice \*self, size_t offset, size_t length)
