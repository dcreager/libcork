...
.. function:: void cork_slice_clear(struct cork_alloc \*alloc, struct cork_slice \*slice)
...
.. function:: int cork_slice_copy(struct cork_alloc \*alloc, struct cork_slice \*dest, struct cork_slice \*src, size_t offset, size_t length, struct cork_error \*err)
              int cork_slice_copy_offset(struct cork_alloc \*alloc, struct cork_slice \*dest, struct cork_slice \*src, size_t offset, struct cork_error \*err)
...
.. function:: int cork_slice_slice(struct cork_alloc \*alloc, struct cork_slice \*slice, size_t offset, size_t length, struct cork_error \*err)
              int cork_slice_slice_offset(struct cork_alloc \*alloc, struct cork_slice \*slice, size_t offset, struct cork_error \*err)
...
.. function:: void cork_slice_finish(struct cork_alloc \*alloc, struct cork_slice \*slice)
...
.. type:: struct cork_slice_iface
   ...
   .. member:: void (\*free)(struct cork_alloc \*alloc, struct cork_slice \*self)
   ...
   .. member:: int (\*copy)(struct cork_alloc \*alloc, struct cork_slice \*self, struct cork_slice \*dest, size_t offset, size_t length, struct cork_error \*err)

      Create a copy of a slice.  You can assume that *offset* and
      *length* refer to a valid subset of *self*\ 's content.

   .. member:: int (\*slice)(struct cork_alloc \*alloc, struct cork_slice \*self, size_t offset, size_t length, struct cork_error \*err)
